...
const Countdown = () => {
  ...
  const timediff = Math.floor(
    new Date("December 15,2022 00:00:00").getTime() - new Date().getTime()
  );
  ...
  return (
    <div className="countdown py-[5px] md:py-[8px] fixed bottom-0 left-0 right-0 z-[999]">
      <div className="items-center justify-between hidden md:flex page-container">
        <div>
      ...
      <div className="mx-[15px] md:hidden block">
